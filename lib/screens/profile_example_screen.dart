...
import 'package:mealsify/widgets/app_bar_title.dart';
import 'package:mealsify/locator.dart';

class ProfileExampleScreen extends StatefulWidget {
  const ProfileExampleScreen({Key? key, required User user})
      : _user = user,
        super(key: key);
  ...
  @override
  _ProfileExampleScreenState createState() => _ProfileExampleScreenState();
}
